export const translations = {
  cs: {
    ...
    story: {
      ...
      nodes: {
        origin: {
          title: "Srdce Rodiny",
          year: "DNES",
          content: "Vše začíná zde. V našem křesle, kde se čas zastaví, {{vocative}}. Tady se tvoří respekt, který se nedá koupit. Jsme MMBarber a toto je naše teritorium."
        },
        vibe: {
    ...
    intelligence: [
      ...
      "Dneska neřeš, co bylo včera, {{vocative}}. Důležité je, jak vypadáš teď a tady.",
      ...
      "Jdeš k nám poprvé, {{vocative}}? Žádný stres. U nás se budeš cítit jako doma.",
      ...
      "Díky, že držíte s námi, {{vocative}}. Vaše loajalita je to, co nás žene dopředu.",
    ...
    services: {
      ...
      subtitle: "Vyber si časový slot podle toho, co potřebuješ, {{vocative}}. Pokud váháš, u křesla to doladíme. Večerní termíny jsou po domluvě otevřené i pro dámy.",
      score: "Zkušenosti",
      bookBtn: "Rezervovat",
      detailsBtn: "Detaily",
      revolutNotice: "",
    ...
    operatives: {
      ...
      barbers: {
        tomas: {
          ...
          chairGreetings: [
            "Sedááj do trůnu, {{vocative}}.",
            "Křeslo čeká, {{vocative}}… respekt taky.",
            ...
            "Sedni si, {{vocative}}, dneska se rodí nový ty.",
      ...
      ranks: {
        l0: "MANAŽER TOALETY",
        l0F: "MANAŽERKA TOALET",
        l1: "KOSMETIK PLOVOUCÍCH KRYTIN",
        l1F: "KOSMETIČKA PLOVOUCÍCH KRYTIN",
        l2: "VELITEL SMETÁKU",
        l3: "STRÁŽCE ČISTÝCH RUČNÍKŮ",
        l4: "PROFESIONÁLNÍ MYČ HLAV",
        l5: "REKRUT S BŘITVOU",
        l6: "POLNÍ MARŠÁL OBRNĚNÝCH NŮŽEK",
        l7: "CEO ÚKLIDOVÉ ČETY",
        l8: "SLUŽEBNÍČEK",
        l9: "GENERÁLNÍ ŘEDITEL STŘIHU",
        l10: "STRATEGICKÝ STŘÍHAČ",
        status: {
    ...
    footer: {
      ...
      mission: "Z LIDÍ VZNIKÁ STYL. ZE STYLU VZNIKÁ ZNAČKA.",
      nav: "Navigace",
      family: "Rodina",
      contact: "Spojení",
      follow: "Sleduj nás",
  ...
  en: {
    ...
    operatives: {
      ...
      ranks: {
        l0: "TOILET MANAGER",
        l1: "FLOORING COSMETICIAN",
        l2: "BROOM COMMANDER",
        l3: "GUARDIAN OF CLEAN TOWELS",
        l4: "PROFESSIONAL HEAD WASHER",
        l5: "RAZOR RECRUIT",
        l6: "FIELD MARSHAL OF ARMORED SCISSORS",
        l7: "CEO OF CLEANING SQUAD",
        l8: "HUMBLE SERVANT",
        l9: "CEO OF CUTS",
        l10: "STRATEGIC CUTTER",
        status: {
    ...
    others: {
      ...
      pece: {
        title: "CARE",
        description: "Magazine about care, cosmetics and skin health.",
        cta: "OPEN MAGAZINE"
      }
    },
    styleDefinition: {
    ...
    footer: {
      ...
      mission: "FROM PEOPLE COMES STYLE. FROM STYLE COMES A BRAND.",
      nav: "Navigation",
      family: "Family",
      contact: "Contact",
      follow: "Follow us",
  ...
  falco: {
    ...
    magazine: {
      ...
      ui: {
        ...
        next: "Next",
        prev: "Previous",
        officialPub: "Official Scientific Publication",
        results: {
          borealis: "PROFILE: BOREALIS",
          meridionalis: "PROFILE: MERIDIONALIS",
          orientalis: "PROFILE: ORIENTALIS",
