export const translations = {
  cs: {
    ...
    operatives: {
      ...
      ranks: {
        ...
        l6: "BARBER PORUČÍK",
        l7: "ELITNÍ BŘITVA",
        l8: "CAPO DI TUTTI CAPI",
        l9: "GENERÁLNÍ ŘEDITEL STŘIHU",
        l10: "GENERALISSIMUS KŘESLA",
        status: {
  ...
  en: {
    ...
    operatives: {
      ...
      ranks: {
        l0: "FLOORING COSMETICIAN",
        l1: "BROOM COMMANDER",
        l2: "GUARDIAN OF CLEAN TOWELS",
        l3: "PROFESSIONAL HEAD WASHER",
        l4: "RAZOR RECRUIT",
        l5: "BARBER LIEUTENANT",
        l6: "ELITE BLADE",
        l7: "CAPO DI TUTTI CAPI",
        l8: "THE DON",
        l9: "CEO OF CUTS",
        l10: "MARSHAL OF MM FAMILY",
        status: {
