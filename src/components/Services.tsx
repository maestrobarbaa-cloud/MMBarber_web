...
export function Services() {
  ...
  const totalValue = useMemo(() => {
    ...
    return total;
  }, [selectedMain, selectedAddons, selectedIndependents, selectedSpecials, t.services]);
        ...
        {showPricing && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-8">
            ...
            <motion.div 
              ...
              className="relative w-full max-w-4xl max-h-[90vh] bg-mafia-dark/40 border border-mafia-gold/30 shadow-[0_0_var(--user-glow-radius)_var(--user-glow-color)] overflow-y-auto scrollbar-thin scrollbar-thumb-mafia-gold/20"
            >
              <div className="sticky top-0 z-20 bg-mafia-black/90 backdrop-blur-md border-b border-mafia-gold/10 p-6 flex flex-wrap items-center justify-between gap-4">
                <h3 className="text-2xl font-heading font-bold text-mafia-gold uppercase tracking-widest">{t.services.title}</h3>
                ...
                <button onClick={() => setShowPricing(false)} className="text-mafia-gold hover:text-mafia-red transition-colors ml-auto"><X size={24} /></button>
              </div>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  {t.services.items.map((svc: { time: string, desc: string, priceValue: number }, i: number) => {
                    ...
                    return (
                      <div 
                        key={i}
                        onClick={() => setSelectedMain(isSelected ? null : i)}
