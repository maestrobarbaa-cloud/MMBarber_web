      ...
      <section className="py-12 px-4 md:px-12 relative max-w-6xl mx-auto min-h-[600px]">
        ...
        >
            ...
            <div className="mt-24 flex flex-col items-center gap-8 opacity-40">
                <div className="w-px h-24 bg-gradient-to-b from-mafia-gold/50 to-transparent"></div>
                <Link href="/" className="text-mafia-gold/60 hover:text-mafia-gold font-sans uppercase tracking-[0.2em] text-xs transition-colors">
                    {t.seznamka.cancelBtn}
                </Link>
            </div>
            )}
        </motion.div>
