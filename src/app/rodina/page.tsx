...
const members = [
  ...
  { 
    ...
    img: "/loga_partneri/o kolečko víc.png", 
                  ...
                  <nav className="flex flex-col gap-2">
                    {divisions.map((div) => (
                      <button
                        ...
                        className={`w-full group relative overflow-hidden border-2 p-6 text-left transition-all duration-500 ${
                          activeDivision === div.id ? 'border-mafia-gold bg-mafia-gold/10 shadow-[0_0_40px_rgba(197,160,89,0.3)]' : 'border-white/5 bg-white/[0.02] hover:border-mafia-gold/40'
                        }`}
                      >
